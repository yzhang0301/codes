...
# OCR Text Recognition request url
url = "http://open.ss.sensetime.com/api/internal_sdk/v1/ocr"
...
if not token:
    ...
    # request parameters
    params = {"modelType": 0,"isResponseImageRequired": False}
